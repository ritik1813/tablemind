...
export default function StepPartySize({ value, onChange, maxOnline = 8, phone = "06-6241-0588" }: Props) {
  const tooLarge = value > maxOnline

  return (
    <div className="flex flex-col items-center gap-6 py-4">
      <p className="text-[#888880] text-sm">How many guests?</p>
      <div className="flex items-center gap-8">
        ...
        <div className="text-center">
          ...
          <p className="text-[#888880] text-sm mt-1">guests</p>
        </div>
        <button
      ...
      {tooLarge && (
        <div className="bg-[#1A1010] border border-[#E24B4A] rounded-xl p-3 text-center text-sm max-w-xs">
          <p className="text-[#E24B4A]">For groups larger than {maxOnline}, please call us:</p>
